...
function itemsGetActiveFiltersSummary() {
  ...
  for (const [key, f] of Object.entries(itemsColFilters)) {
    ...
    } else if (["race_select", "merchant_select", "class_select", "tag_select", "item_type_select"].includes(col.type)) {
      const keys = { race_select: "races", merchant_select: "merchants", class_select: "classes", tag_select: "enchant_tags", item_type_select: "item_types" };
