...
//             ui-table-refresh.js (itemsRefreshTable), icons.js (icon)
...
function _itemsEnsureColFilterPanel() {
  ...
  _cfPanel.addEventListener("input", e => {
    ...
    if (!col || col.type === "race_select" || col.type === "merchant_select" || col.type === "profession_select" || col.type === "class_select") return;
  ...
  _cfPanel.addEventListener("change", e => {
    ...
    if (col?.type === "bool" && e.target.type === "radio") {
      ...
      itemsRefreshTable();
    } else if ((col?.type === "race_select" || col?.type === "merchant_select" || col?.type === "class_select") && e.target.classList.contains("ext-cfp-race-opt")) {
      const fk = col.type === "race_select" ? "races" : col.type === "merchant_select" ? "merchants" : "classes";
      if (!itemsColFilters[key]) itemsColFilters[key] = {};
