...
// Depends on: common/api-handler.js (apiGetCacheByPattern), features/tournament/main.js (_T_GLAD_H)
...
function _parseColumns() {
  // The game uses .ladder-full, but sometimes omits it in regular tournaments, 
  // keeping only the .ladder-holder parent.
