...
//
// Depends on: common/utils.js (swedishDateToday, swedishMidnightUTC, gameRequest),
//             common/settings.js (loadSettings), common/api-handler.js (apiRegisterHandler).
...
function _effectiveLimit() {
  ...
  if (limitVal == null) {
    console.error("[Lanista-Ext] daily_team_beasts limit missing from ExtConfig");
    return null;
  }
  return parseInt(limitVal, 10);
}
