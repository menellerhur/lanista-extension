...
// Depends on: utils.js (getGameContentRoot), settings.js (loadSettings),
//             tournament/parse.js (_parseColumns, _computeUnit),
//             tournament/render.js (_renderBracket),
//             tournament/info-layout.js (_applyInfoLayout, _removeInfoLayout)
...
function _setupObs() {
  ...
  _tournamentObs = new MutationObserver(() => {
    ...
    const hasLadder  = !!document.querySelector('.ladder-full');
